...
def create_app(test_config=None):
    ...
    @app.route("/vaderexample")
    def generateExample():
        sentences = ["Fixed crappy implementation of templates.",
                    "Reverted temporary fix #32341.",
                    "Updated formatting to better reflect common practices.",
                    "Readme should be good now.",
                    "Ffs... Please don't use unnecessary spacing."
                    ]
    ...
    def repositoriesCommits():
        ...
        def getRepositories(page="1", perPage="100", query=None):
            ...
            totalCount = 0
            analyzer = SentimentIntensityAnalyzer()
            # start on 1 because intitial fetching of repos is considered as one search request
            nr = 1
